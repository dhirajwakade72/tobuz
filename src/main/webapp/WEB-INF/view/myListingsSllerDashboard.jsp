...
<html lang="en">
<head>
  <title>Tobuz - My Packages Seller Dashboard</title>
  <meta charset="utf-8">
...
<div>
<div class="my-destboard"><a href="sellerHome">My Dashboard</a></div>
<div class="My-Packages"><a href="myPackagesSeller">My Packages</a></div>
<div class="listing-active"><a href="#">My Listings</a></div>
...
<div class="dropdown dashboard">
  <button class="btn btn-secondary dashboard-leftmenu dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
   <div class="My-Packages-active"><a href="myPackagesSeller">My Packages</a></div>
  </button>
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
<div class="My-Packages"><a href="myPackagesSeller">My Packages</a></div>
<div class="listing-active"><a href="#">My Listings</a></div>
...
<div class="buyer-create-list-button"><a href="createBusinessListings" class="btn Business-btn">Create Listing</a></div>
</div>
</div>
...
<div class="warpper">
  ...
  <!-- tab area start -->
  <div class="tabs-1">
  <label class="tab" id="one-tab" for="one">Business <span class="number-count" id="bunnum">0</span></label>
  <label class="tab" id="two-tab" for="two">Commercial <span class="number-count"  id="comnum">0</span></label>
  <label class="tab" id="three-tab" for="three">Franchise <span class="number-count"  id="frnum">0</span></label>
    </div>
	<!-- tab area finish -->
  ...
  <!-- Fetured Listings slider start -->
    <!-- table start -->
<div class="my-package-1">
<table id="businessTab">
  <tr>
    <th>Advert Id</th>
    <th>Title</th>
    <th>Views</th>
...
Apparel & Footwear</td>
	...
	<td>Pending<br/>
Approval</td>
	<td><a href=""><img src="images/edit.png" width="24" height="24"/></a> <img src="images/delete.png" width="24" height="24"/></a></td>
  </tr>
 <tr>
    <td>B-4569</td>
    <td>Looking for sale<br/> 
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>	
 <!-- <script src="js/jquery.slim.min.js"></script> -->
  ...
  jQuery(document).ready(function($){
	  getAdvertListForBusiness('BUSINESS');
	  getAdvertListForCommerce('COMMERCIAL');
	  getAdvertListForFranchise('FRANCHISE');
	  
  });
  
  function getAdvertListForBusiness(type) {
	  
	  var getUrl = window.location;
		
		  var url = getUrl .protocol + "//" + getUrl.host + "/getAdvertListingsForTypeAndUser" ;
			    ...
			    dataType: 'json',
			      success: function(data) {
			    		...
			    		$.each(data, function (index, value) {
							var tRow = "<tr>";
							tRow+="<td>"+value.advertId+"</td>";
							tRow+="<td>"+value.title+"</td>";
							tRow+="<td>"+value.views+"</td>";
							tRow+="<td>"+value.packag+"</td>";
							tRow+="<td>"+value.createdOn+"</td>";
							tRow+="<td>"+value.expiredOn+"</td>";
							tRow+="<td>"+value.status+"</td>";
							tRow+="<td><a href=\"\"><img src=images/edit.png  onclick =editSaveBusiness("+value.id+") width=24 height=24/></a> <img src=images/delete.png width=24 height=24/></a></td>";
					        console.log("***************************");
					     	console.log (value.title);
					     	console.log (value.advertId);
					     
					     	 console.log("***************************");
					     	 
					     	tRow+="</tr>";
					     	$('#businessTab').append(tRow);
					     	console.log ("data.length :"+data.length);
					     	$("#bunnum").html(data.length);
						});
...
function getAdvertListForCommerce(type) {
			    ...
			    dataType: 'json',
			      success: function(data) {
			    		...
			    		$.each(data, function (index, value) {
							...
							tRow+="<td>"+value.expiredOn+"</td>";
							tRow+="<td>"+value.status+"</td>";
							tRow+="<td><a href=\"\"><img src=images/edit.png width=24 height=24/></a> <img src=images/delete.png width=24 height=24/></a></td>";
					        console.log("***************************");
					     	console.log (value.title);
					     	console.log (value.advertId);
					     	...
					     	tRow+="</tr>";
					     	$('#commercialTab').append(tRow);
					    	console.log ("data.length :"+data.length);
					     	$("#comnum").html(data.length);
						});
...
function getAdvertListForFranchise(type) {
			      ...
			      success: function(data) {
			    		...
			    		$.each(data, function (index, value) {
					        ...
					        console.log("***************************");
					     	...
					     	tRow+="</tr>";
					     	$('#franchiseTab').append(tRow);
					     	console.log ("data.length :"+data.length);
					     	$("#frnum").html(data.length);
