...
<html lang="en">
<head>
  <title>Tobuz - My Adverts Buyer Dashboard</title>
  <meta charset="utf-8">
...
<div class="dropdown dashboard">
  <button class="btn btn-secondary dashboard-leftmenu dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
   <div class="My-Adverts-active"> <a href="myAdvertsBuyeDashboard">My Adverts</a></div>
  </button>
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
  <div class="my-destboard"><a href="#">My Dashboard</a></div>
   <div class="My-Packages"><a href="myPackagesSeller">My Packages</a></div>
   <div class="Favorites"> <a  href="myFavouritesSeller">Favorites</a></div>
...
<!--  <script src="js/jquery.slim.min.js"></script> -->
  ...
  var getUrl = window.location;
	var url = getUrl .protocol + "//" + getUrl.host + "/findBusinessAdvertsforUser"
