...
<!--title start-->
<h1>Looking for sale Construction & Real Estate Business<br/>
<span>Looking For Sale Construction & Real Estate Business</span>
</h1>
<!--title finish-->
<div class="row">
 ...
 <!-- <ul class="carousel-indicators">
  ...
  <div class="carousel-inner mb-20">
    <div class="carousel-item active">
      <img src="images/service-banner.jpg" class="br-20" alt="Service banner 1" width="100%" height="auto">
        
    </div>
    <div class="carousel-item">
      <img src="images/service-banner.jpg" class="br-20" alt="Service banner 2" width="100%" height="auto">
        
    </div>
    <div class="carousel-item">
      <img src="images/service-banner.jpg" class="br-20" alt="Service banner 3" width="100%" height="auto">
...
<h2 class="contact-h2">Contact Buyer</h2>
<form>
<div class="row">
...
<p class="business-text"><span class="business-description">Advert Summary</span><br/> <span class="business-description">Business Location</span><br/>
Najibabad,Uttar Pradesh,India
</p>
<!--Advert Summary finish-->
<!--Industry start-->
<p class="business-text"><span class="business-description">Industry</span><br/>
Construction & Real Estate Business, Hotel, Restaurants and Food Services
</p>
<!--Industry finish-->
<!--Sub-Category start-->
<p class="business-text"><span class="business-description">Sub-Category</span><br/>
Banqueting Halls , Hotels & Resorts
</p>
<!--Sub-Category finish-->
<!--Company Type start-->
<p class="business-text"><span class="business-description">Company Type</span><br/>
N/A
</p>
<!--Company Type finish-->
<!--Source of Business start-->
<p class="business-text"><span class="business-description">Source of Business</span><br/>
N/A
</p>
...
<!--social icon finish-->
<!--listing start-->
<div class="listing-id">Advert ID<br/><span>B-5313</span></div>
<div class="listing-id">Advert Category<br/><span>Business</span></div>
<div class="listing-id">Total Views<br/><span>49</span></div>
<div class="listing-id">Investment Range<br/><span>INR 50,00,000</span></div>
<!--finish finish-->
</div>
</div>
</div>
