...
<html lang="en">
<head>
  <title>Tobuz - Membership Packages Dashboard</title>
  <meta charset="utf-8">
...
<div class="container">
<div class="row mb-20px desktop-view">
<!--box 1 start-->
<div class="col-lg-3 col-xl-3 col-md-6">
<div class="mambership-top">
Choose a Plan<br/>
<span>Sell Your Business at<br/>
the Best Value</span>
</div>
<div class="center-bg">Display Your Profile on Tobuz.com</div>
<div class="center-bg-3">View Seller/Buyer Contact Information</div>
<div class="center-bg-3">View Other Businesses and Properties Details</div>
<div class="center-bg-3">Tobuz Verified Status for your Listing</div>
<div class="center-bg-3">Tobuz will connect you with hand-picked Sellers</div>
<div class="center-bg-3">Tobuz will connect you with hand-picked Sellers</div>
</div>
<!--box 1 finish-->
<!--box 1 start-->
...
<div class="center-bg-1"><i class="fa fa-check green-right" aria-hidden="true"></i></div>
<div class="center-bg-2"><i class="fa fa-close red-wrong" aria-hidden="true"></i></div>
<div class="center-bg-2"><i class="fa fa-close red-wrong" aria-hidden="true"></i></div>
<div class="center-bg-2"><i class="fa fa-close red-wrong" aria-hidden="true"></i></div>
<div class="center-bg-2"><i class="fa fa-close red-wrong" aria-hidden="true"></i></div>
<div class="center-bg-2"><i class="fa fa-close red-wrong" aria-hidden="true"></i></div>
<div class="merber-button"><a href="" class="btn free-btn">Buy Now</a></div>
</div>
</div>
<!--box 1 finish-->
<!--box 1 start-->
<div class="col-lg-3 col-xl-3 col-md-6">
<div class="zoom-effect">
<div class="silver-top">
SLIVER<br/>
<span>INR 2000<br/>
6 Months</span>
</div>
<div class="center-bg-1"><i class="fa fa-check green-right" aria-hidden="true"></i></div>
<div class="center-bg-2"><i class="fa fa-check green-right" aria-hidden="true"></i></div>
<div class="center-bg-2"><i class="fa fa-check green-right" aria-hidden="true"></i></div>
<div class="center-bg-2"><i class="fa fa-check green-right" aria-hidden="true"></i></div>
<div class="center-bg-2"><i class="fa fa-check green-right" aria-hidden="true"></i></div>
<div class="center-bg-2"><i class="fa fa-check green-right" aria-hidden="true"></i></div>
<div class="merber-button"><button type="button" class="btn silver-btn">Buy Now</button></div>
</div>
</div>
<!--box 1 finish-->
<!--box 1 start-->
...
<div class="center-bg-2"><i class="fa fa-check green-right" aria-hidden="true"></i></div>
<div class="center-bg-2"><i class="fa fa-check green-right" aria-hidden="true"></i></div>
<div class="merber-button"><button type="button" class="btn gold-btn-1">Buy Now</button></div>
</div>
</div>
<!--box 1 finish-->
</div>

<div class="row mb-20px mobile-view">
...
<div class="center-bg-2"><i class="fa fa-close red-wrong" aria-hidden="true"></i></div>
<div class="center-bg-2"><i class="fa fa-close red-wrong" aria-hidden="true"></i></div>
<div class="merber-button"><button type="button" class="btn free-btn">Buy Now</button></div>
</div>
	 </td>
    <td  align="top" valign="top">
	<div class="silver-top">
...
<div class="center-bg-2"><i class="fa fa-check green-right" aria-hidden="true"></i></div>
<div class="center-bg-2"><i class="fa fa-check green-right" aria-hidden="true"></i></div>
<div class="merber-button"><button type="button" class="btn gold-btn">Buy Now</button></div>
</div>
	</td>
  </tr>
</table>
