...
<html lang="en">
<head>
  <title>Tobuz - Switch to Franchisor Dashboard</title>
  <meta charset="utf-8">
...
<div class="My-Packages"><a href="myPackagesBroker">My Packages</a></div>
<div class="My-Adverts"><a href="">My Adverts</a></div>
<div class="Favorites"><a href="">Favorites</a></div>
<div class="Saved-Search"><a href="">Saved Search</a></div>
<div class="Messages"><a href="myMessagesBroker">Messages</a></div>
...
<div class="dropdown dashboard">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
   <div class="My-Packages"><a class="dropdown-item" href="myPackagesBroker">My Packages</a></div>
   <div class="My-Adverts"> <a class="dropdown-item" href="#">My Adverts</a></div>
...
<div class="Messages"><a class="dropdown-item" href="myMessagesBroker">Messages</a></div>
...
<div class="buyer-des">Broker</div>
...
<div class="mobile-view col-12" style="margin-bottom:20px;">
<div class="my-destboard-active"><a href="">My Dashboard</a></div>
...
<!-- image start -->
<img src="images/Fetured-Listings.png" width="100%" title="Running Salon For Sale In Chandigarh" alt="Running Salon For Sale In Chandigarh"/>
<!-- image finish -->
<div class="pd10">
<!-- meta start -->
<div class="alt"><a href="">Business For Sale Of Healthcare & Pharmaceuticals 
At Dubai,Dubai,UAE</a></div>
<!-- meta finish -->
<!-- title start -->
<div class="title"><a href="">Established Multispecialty Clinic</a></div>
<!-- title finish -->
<!-- price start -->
<div class="price-location-area">
 <div class="price"><img src="images/dollar-icon-sale.jpg" title="dollar" alt="dollar" class="dollar-icon"/> AED 3,000,000</div>
 <!-- price finish -->
 <!-- location start -->
...
<div class="col-lg-4 col-xl-4 col-md-12">
<div class="sale-image-area">
<img src="images/Fetured-Listings-1.png" width="100%" title="Running Salon For Sale In Chandigarh" alt="Running Salon For Sale In Chandigarh"/>
<div class="pd10">
...
<div class="col-lg-4 col-xl-4 col-md-12">
<div class="sale-image-area">
<img src="images/Fetured-Listings-2.png" width="100%" title="Running Salon For Sale In Chandigarh" alt="Running Salon For Sale In Chandigarh"/>
<div class="pd10">
<div class="alt"><a href="">Franchise For Sale Of Hotel, Restaurants And
