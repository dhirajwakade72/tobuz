...
<html lang="en">
<head>
  <title>Tobuz - My Listings Favorites Dashboard</title>
  <meta charset="utf-8">
...
<div class="listing-active"><a href="my-listings-favorites-dashboard.html">My Listings</a></div>
...
<div class="dropdown dashboard">
  <button class="btn btn-secondary dashboard-leftmenu dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
   ...
   <div class="listing"><a href="my-listings-favorites-dashboard.html">My Listings</a></div>
  </button>
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
  <div class="my-destboard"><a href="switch-to-franchisor-dashboard.html">My Dashboard</a></div>
   <div class="My-Packages"><a href="my-packages-favorites-dashboard.html">My Packages</a></div>
...
<div class="buyer-des">Franchisor</div>
...
<div class="warpper">
  ...
  <!-- tab area start -->
  <div class="tabs-1">
  <label class="tab" id="one-tab" for="one">Franchisor New <span class="number-count">0</span></label>
  <label class="tab" id="two-tab" for="two">Franchisor Resale <span class="number-count">0</span></label>
    </div>
	<!-- tab area finish -->
