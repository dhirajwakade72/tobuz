...
<html lang="en">
<head>
  <title>Tobuz - Messages Dashboard</title>
  <meta charset="utf-8">
...
<div class="row desktop-view">
                                 <div class="col-lg-5 col-xl-5 col-md-5">
									...
									<div class="massage-deshboard">
<div class="input-group">
  <input type="search" class="form-control massage-round-bar" aria-label="Search" aria-describedby="search-addon">
  <button type="button" class="btn massage-round-button"><i class="fa fa-search" style="color:#00498e;"></i></button>
</div>
</div>
									<a class="nav-link box-massage-1 active" data-toggle="pill" href="#tab-1" role="tab"><div class="row">
<div class="col-lg-3 col-xl-3 col-md-3 col-3"><img src="images/profile.jpg" width="100%" alt="Parag Gogari" title="Parag Gogari"></div>
<div class="col-lg-9 col-xl-9 col-md-9 col-9 pl-0">
<div class="name-massage">Parag Gogari <span class="time-massage">11:26</span></div>
<div class="post-massage">Business For Sale Of Healthcare <span class="count-massage">1</span></div>
</div>
</div></a> <a class="nav-link box-massage-1" data-toggle="pill" href="#tab-2" role="tab"><div class="row">
<div class="col-lg-3 col-xl-3 col-md-3 col-3"><img src="images/profile.jpg" width="100%" alt="Parag Gogari" title="Parag Gogari"></div>
<div class="col-lg-9 col-xl-9 col-md-9 col-9 pl-0">
<div class="name-massage">Parag Gogari <span class="time-massage">11:26</span></div>
<div class="post-massage">Business For Sale Of Healthcare <span class="star-icon"><i class="fa fa-star" aria-hidden="true"></i></span></div>
</div>
</div></a> <a class="nav-link box-massage-1" data-toggle="pill" href="#tab-3" role="tab"><div class="row">
<div class="col-lg-3 col-xl-3 col-md-3 col-3"><img src="images/profile.jpg" width="100%" alt="Parag Gogari" title="Parag Gogari"></div>
<div class="col-lg-9 col-xl-9 col-md-9 col-9 pl-0">
<div class="name-massage">Parag Gogari <span class="time-massage">11:26</span></div>
<div class="post-massage">Business For Sale Of Healthcare <span class="star-icon"><i class="fa fa-star" aria-hidden="true"></i></span></div>
</div>
</div></a> <a class="nav-link box-massage-1" data-toggle="pill" href="#tab-4" role="tab"><div class="row">
<div class="col-lg-3 col-xl-3 col-md-3 col-3"><img src="images/profile.jpg" width="100%" alt="Parag Gogari" title="Parag Gogari"></div>
<div class="col-lg-9 col-xl-9 col-md-9 col-9 pl-0">
<div class="name-massage">Parag Gogari <span class="time-massage">11:26</span></div>
<div class="post-massage">Business For Sale Of Healthcare <span class="star-icon"><i class="fa fa-star" aria-hidden="true"></i></span></div>
</div>
</div></a> <a class="nav-link box-massage-1" data-toggle="pill" href="#tab-5" role="tab"><div class="row">
<div class="col-lg-3 col-xl-3 col-md-3 col-3"><img src="images/profile.jpg" width="100%" alt="Parag Gogari" title="Parag Gogari"></div>
<div class="col-lg-9 col-xl-9 col-md-9 col-9 pl-0">
<div class="name-massage">Parag Gogari <span class="time-massage">11:26</span></div>
<div class="post-massage">Business For Sale Of Healthcare <span class="star-icon"><i class="fa fa-star" aria-hidden="true"></i></span></div>
...
<a href="#" class="icon-delete"><i class="fa fa-trash" aria-hidden="true"></i></a> <a href="#" class="icon-delete"><i class="fa fa-star" aria-hidden="true"></i></a> 
</div>
<div class="clear"></div>
<!-- massage box start -->
<div class="row box-massage-right">
<div class="col-lg-3 col-xl-1 col-md-3 col-2 pl-0 pr-0"><img src="images/profile.jpg" width="100%" alt="Parag Gogari" title="Parag Gogari"></div>
<div class="col-lg-9 col-xl-8 col-md-9 col-7">
<div class="name-massage">Parag Gogari <span class="fs10">Business For Sale Of Healthcare </span></div>
</div>
<div class="col-lg-9 col-xl-3 col-md-9 col-3 pl-0 pr-0">
<div class="time-massage">30 Jan 2023 11:26</div>
</div>
</div>
<!-- massage box finish -->
<!-- massage box start -->
<div class="row box-massage-right">
<div class="col-lg-3 col-xl-1 col-md-3 col-2 pl-0 pr-0"><img src="images/arrow-you.jpg" width="100%" alt="Parag Gogari" title="Parag Gogari"></div>
<div class="col-lg-9 col-xl-8 col-md-9 col-7">
<div class="name-massage">You <span class="fs10">Business For Sale Of Healthcare </span></div>
</div>
<div class="col-lg-9 col-xl-3 col-md-9 col-3 pl-0 pr-0">
<div class="time-massage">30 Jan 2023 11:26</div>
</div>
...
<!-- massage box finish -->
<div class="row massage-area">
<p>Hi,</p>
<p>djsvfdfkngklfmhlgf.;j,kkl/hj?K..?S;djokjjl’;‘’chjlajodnoidnkijubmmkdhjbdkuin 
mdijsmlksm undcnl’ A?skssldklls;dldl;f;f</p>
<!-- What you liked about us start -->
<div class="form-group mb-20 required-field-block">       
        <div class="input-group">
            <textarea rows="4" size="50" value="" class="form-control interested" placeholder="Write Your Massage..."></textarea>  
        </div>
    </div>
	<!-- What you liked about us finish -->
	<div class="float-right" style="width:100%;">
	<button type="button" style="float:right;" class="btn login-submit-button">Send</button>
</div></div>
</div>
...
<!-- search box finish -->
<div class="massage-deshboard-1">
<!-- massage box start -->
<a href="messages-dashboard-mobile.html"><div class="row box-massage-2">
<div  class="col-lg-3 col-xl-3 col-md-3 col-3"><img src="images/profile.jpg" width="100%" alt="Parag Gogari" title="Parag Gogari"/></div>
<div  class="col-lg-9 col-xl-9 col-md-9 col-9 pl-0">
<div class="name-massage">Parag Gogari <span class="time-massage">11:26</span></div>
<div class="post-massage">Business For Sale Of Healthcare <span class="count-massage">1</span></div>
