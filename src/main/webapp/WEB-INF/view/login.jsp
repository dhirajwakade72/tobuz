...
<span class="login-area"><a href="#">Login</a> | <a href="register">Register</a> </span>
...
<div class="dropdown coun-flag">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<!-- Code for mobile menu for display header menus -->
        <!-- mobile menu start -->
            <li class="nav-item">
...
<div class="tobuslogin">
<div class="Tobuz-login">Tobuz</div>
<p class="login-text">Transforming And Simplifying The Way Businesses And 
Commercial Properties Are Bought, Sold And Leased</p>
</div>
</div>
<!-- Tobuz area finish -->
<!-- login area start -->
...
<div class="loginarea">
<!-- login title start -->
<div class="sigh-in"><h1>Sign In</h1></div>
<span  class="alert" style="border-radius: 15px; width:90% ;margin-left: 5%">
</span>
<!-- login title finish -->
<form>
...
<!-- submit button start -->
<div class="login-submit-button-area"><button type="submit" class="btn login-submit-button">Submit</button></div>
<!-- submit button finish -->
</form>
<!-- or sign in using start -->
<div class="or"><img src="images/or.png" width="222" height="11" align="center"/></div>
<!-- or sign in using finish -->
<!-- social area start -->
<div class="login-social"><span><img src="images/google.jpg" width="25" height="25"/></span><span style="margin:0 10px;"><img src="images/facebook.jpg" width="25" height="25"/></span><span><img src="images/linkedin.jpg" width="25" height="25"/></span></div>
<!-- social area finish -->
</div>
</div>
<!-- login area start -->
...
<!--  <script src="js/jquery.slim.min.js"></script> -->
  ...
  function isEmail(email) {
 	 ...
 	 if (($.trim(email)!= "")  && (isEmail(email) == false)){
 		 $(".alert").show();
		 $(".alert").html("<strong>Invalid Email</strong> ");
		 event.preventDefault();
		 return ;
 	 }
	 var password = $("#password").val();
	 var url = getUrl .protocol + "//" + getUrl.host + "/loginUser" ;
	 ...
	 event.preventDefault();
	  $.ajax({
	        ...
	        success: function (data) {
	        	...
	        	if (data.role == 'BUYER'){
	        		url = getUrl .protocol + "//" + getUrl.host + "/buyerHome"
	        		window.location.href =url;
	        	}
	        	if (data.role == 'SELLER'){
	        		url = getUrl .protocol + "//" + getUrl.host + "/sellerHome"
	        		window.location.href =url;
	        	}
	        	if (data.role == 'BROKER'){
	        		url = getUrl .protocol + "//" + getUrl.host + "/brokerHome"
	        		window.location.href =url;
	        	}
	        	if (data.role == 'ADMIN'){
	        		url = getUrl .protocol + "//" + getUrl.host + "/adminDashboard"
	        		window.location.href =url;
	        	}
	        ...
	        error: function (e) {
	        	 $(".alert").show();
				 $(".alert").html("<strong>Error in Login</strong> ");
	        }
	    });
	}); 
