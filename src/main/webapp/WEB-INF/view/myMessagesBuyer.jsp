...
<div class="Messages-active"><a href="#">Messages</a></div>
...
$(document).ready(function() {
   ...
   /*  var getUrl = window.location;
    ...
    var url = getUrl .protocol + "//" + getUrl.host + "/getNumberOfUsers" ;
	console.log ("url >>>>>>>"+url);		
	$.ajax({
        url: url,
        type: 'GET',
        dataType: 'json', // added data type
        success: function(data) {
        	console.log( "getNumberOfUsers :"+data);
...
function doAction(status ,id){
	 ...
	 var obj = {"businessListingStatus":status,"id":id};

	 var getUrl = window.location;
	  var url = getUrl .protocol + "//" + getUrl.host + "/getUserMessages" ;
	  $.ajax({
	        type: "POST",
	        url: url,
	        ...
	        success: function (data) {
	        	...
	        	url = getUrl .protocol + "//" + getUrl.host + "/getUserMessages" ;
