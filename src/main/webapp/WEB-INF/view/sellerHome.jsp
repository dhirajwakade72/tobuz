...
<html lang="en">
<head>
  <title>Tobuz - Switch to Seller Dashboard</title>
  <meta charset="utf-8">
...
<span class="switch-area"><div class="dropdown">
 ...
 <div class="profile-name" id="profileName3">Parag Gogari</div>
 </span>
...
<div class="dropdown coun-flag">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<li class="d-inline d-lg-none">
	 ...
	 <div class="profile-photo"><img src="images/profile.jpg" width="28" height="28"/></div>
 <div class="profile-name" id="profileName4">Parag Gogari</div>
	 </li>
...
<div class="My-Packages"><a href="myPackagesSeller">My Packages</a></div>
<div class="listing"><a href="myListingsSllerDashboard">My Listings</a></div>
<div class="Favorites"><a href="myFavouritesSeller">Favorites</a></div>
<div class="Saved-Search"><a href="">Saved Search</a></div>
<div class="Messages"><a href="myMessagesSeller">Messages</a></div>
...
<div class="dropdown dashboard">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
   <div class="My-Packages"><a class="dropdown-item" href="myPackagesSeller">My Packages</a></div>
   <div class="My-Adverts"> <a class="dropdown-item" href="myadvertsSeller">My Adverts</a></div>
...
<div class="Messages"><a class="dropdown-item" href="myMessagesSeller">Messages</a></div>
...
<div class="name" id="profileName1">Parag Gogari</div><br/>
<div class="buyer-des">Seller</div>
...
<div class="name" id="profileName2">Parag Gogari</div><br/>
<div class="buyer-des">Seller</div>
<div class="buyer-create-list-button"><button type="button" class="btn Business-btn">Create Listing</button></div>
</div>
...
<div class="score-bg">Favorites<br/><span>50</span></div>
</div>
<div class="col-lg-3 col-xl-3 col-md-6">
...
<!-- bfs grid 1 start -->
<div class="col-lg-4 col-xl-4 col-md-12 seller-a">
<a href="#">
			...
			$.each(data, function (index, value) {
		        ...
		        console.log("***************************");
		     	...
		     	if (index==3){
		     		...
		     		$("#firstDesc").html((value.description.substring(0, 124)+"..."));
		     	...
		     	if (index==6){
		     		...
		     		$("#secondDesc").html((value.description.substring(0, 124)+"..."));
		     	...
		     	if(index==9){
		     		...
		     		$("#thirdDesc").html((value.description.substring(0, 124)+"..."));
			   ...
			   var slides= "";
				...
				$.each(data, function (index, value) {
			       ...
			       if (index==8){
			     		...
			     		$("#fourthDesc").html((value.description.substring(1, 124)+"..."));
			       ...
			       if (index==3){
			     		...
			     		$("#fifthDesc").html((value.description.substring(1, 124)+"..."));
			       ...
			       if (index==2){
			     		...
			     		$("#sixthDesc").html((value.description.substring(1, 124)+"..."));
