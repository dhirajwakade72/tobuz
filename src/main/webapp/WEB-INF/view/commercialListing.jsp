...
<html lang="en">
<head>
  <title>Tobuz - Commercial Listing</title>
  <meta charset="utf-8">
...
<!--title start-->
<h1>Profitable McDonalds (Drive thru) For Sale With Land And Property Near Gurgaon<br/>
<span>Commercial For Sale Of Hotel/ Leisure At Haryana, Gurgaon, India</span>
</h1>
<!--title finish-->
<!--post start-->
 ...
 <!-- <ul class="carousel-indicators">
  ...
  <div class="carousel-inner mb-20">
    <div class="carousel-item active">
      <img src="images/commercial-listing.jpg" class="br-20" alt="Service banner 1" width="100%" height="auto"/>
        
    </div>
    <div class="carousel-item">
      <img src="images/commercial-listing.jpg" class="br-20" alt="Service banner 2" width="100%" height="auto"/>
        
    </div>
    <div class="carousel-item">
      <img src="images/commercial-listing.jpg" class="br-20" alt="Service banner 3" width="100%" height="auto"/>
...
<!--Advert Summary start-->
<p class="business-text"><span class="business-description">Commercial Description</span><br/>
Running McDonalds (Drive-thru) Near Gurgaon, with land and property for sale - Profitable - tenure till 2043 - excellent investment - self running (Auto Pilot) model
</p>
<!--Advert Summary finish-->
<!--Industry start-->
<p class="business-text"><span class="business-description">Commercial Category</span><br/>
Retail Businesses<br/>
Other Retail Business
</p>
<!--Industry finish-->
<!--Sub-Category start-->
<p class="business-text"><span class="business-description">Commercial Location</span><br/>
Gurgaon, Haryana, India
</p>
<!--Sub-Category finish-->
<!--Company Type start-->
<p class="business-text"><span class="business-description">Commercial Features</span><br/>
Attractive Business
</p>
<!--Company Type finish-->
<!--Source of Business start-->
<p class="business-text"><span class="business-description">Commercial Information</span><br/>
Availability : Ready to move<br/>
Property Age : 10<br/>
Build up Area : 6500 Square ft
</p>
<!--Source of Business finish-->
<!--Source of Business start-->
<p class="business-text"><span class="business-description">Amenities</span><br/>
Centrally Air Conditioned
</p>
<!--Source of Business finish-->
<!--Source of Business start-->
<p class="business-text"><span class="business-description">Keywords</span><br/>
Profitable Hotel Business for sale
</p>
<!--Source of Business finish-->
</div>
</div>
...
<!--social icon finish-->
<!--listing start-->
<div class="listing-id">Listing ID<br/><span>L-34616</span></div>
<div class="listing-id">Listing Type<br/><span>SALE</span></div>
<div class="listing-id">Listing Category<br/><span>Commercial</span></div>
<div class="listing-id">Total Views<br/><span>10</span></div>
<div class="listing-id">Pricing<br/><span>INR 55,000,000</span></div>
<!--finish finish-->
</div>
</div>
</div>
