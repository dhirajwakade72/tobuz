...
<div class="password-alert">Your Password has been changed Successfully</div>
<div class="loginarea">
<!-- login title start -->
<div class="changepassword"><h1>Change Password</h1></div>
<!-- login title finish -->
<form>
<!-- password area start -->
<div class="input-group mb-3">
  ...
  <input type="text" class="form-control login-user" placeholder="Old Password" aria-label="oldPassword" aria-describedby="basic-addon1">
</div>
<!-- password area finish -->
<!-- password area start -->
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="basic-addon1"><img src="images/lock-1.png" width="33" height="24"/></span>
  </div>
  <input type="text" class="form-control login-user" placeholder="New Password" aria-label="newPassword" aria-describedby="basic-addon1">
</div>
<!-- password area finish -->
<!-- password area start -->
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="basic-addon1"><img src="images/lock-2.png" width="33" height="21"/></span>
  </div>
  <input type="text" class="form-control login-user" placeholder="Confirm Password" aria-label="confPassword" aria-describedby="basic-addon1">
</div>
<!-- password area finish -->

<!-- submit button start -->
<div class="login-submit-button-area"><button type="submit" class="btn login-submit-button">Update</button></div>
