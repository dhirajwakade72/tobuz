...
<div class="My-Packages-active"><a href="#">My Packages</a></div>
...
<div class="dropdown dashboard">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
   <div class="my-destboard"><a href="buyerHome">My Dashboard</a></div>
    <div class="listing"> <a href="myListingsSllerDashboard">My Listings</a></div>
   <div class="Favorites"> <a href="myFavouritesSeller">Favorites</a></div>
   <div class="Saved-Search"><a href="#">Saved Search</a></div>
<div class="Messages"><a href="myMessagesSeller">Messages</a></div>
...
<div class="buyer-create-list-button"><a href="create-business-listings-dashboard.html" class="btn Business-btn">Create Listing</a></div>
</div>
</div>
...
<div class="my-package-button"><a href="membership-packages-dashboard.html" class="package"><img src="images/plus.png" width="15" height="15" style="margin-right:5px;"> Package</a></div>
<!-- package button finish -->
<!-- table start -->
<div class="my-package">
<table id="myPackageTable">
  <tr>
    <th>Package Name</th>
    <th>Purchased On</th>
    <th>Expiry Date</th>
  ...
  <!-- <tr>
	...
	<td>Business</td>
	<td>0</td>
	<td><button type="button" class="btn create-advert"><img src="images/business-listting-icon.jpg" width="11" height="11" style="margin-right:5px; margin-top:-2px;">Business Listing</button></td>
  </tr>
  <tr>
    <td>Free</td>
    <td>08-Jun-2022</td>
...
<!-- footer area finish -->
 ...
 <!-- <script src="js/jquery.slim.min.js"></script> -->
  ...
  var getUrl = window.location;
	var url = getUrl .protocol + "//" + getUrl.host + "/getPackageInfoForSeller"
	  ...
	  $.ajax({
		     ...
		     success: function(data) {
					...
					$.each(data, function (index, value) {
						var tRow = "<tr>";
						tRow+="<td>"+value.packageType+"</td>";
						tRow+="<td>"+value.createdOn+"</td>";
						tRow+="<td>"+value.expairyDate+"</td>";
						tRow+="<td>"+value.advertListCount+"</td>";
						tRow+="<td>"+value.userPackageStatus+"</td>";
						tRow+="<td>"+value.packageActiveFor+"</td>";
						tRow+="<td>"+value.noContactAccess+"</td>";
						tRow+="<td><button type=button class=btn create-advert><img src=images/business-listting-icon.jpg width=11 height=11 style=margin-right:5px; margin-top:-2px;>Business Listing</button></td>";
				        console.log("***************************");
				     	console.log (value.packageType);
				     	console.log (value.userPackageStatus);
				     
				     	 console.log("***************************");
				     	 
				     	tRow+="</tr>";
				     	$('#myPackageTable').append(tRow);
					});
