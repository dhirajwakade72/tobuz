...
<html lang="en">
<head>
  <title>Tobuz - Contact Seller</title>
  <meta charset="utf-8">
...
<div class="col-md-8 col-lg-9 col-xl-10 contact-seller-title">
<!--title start-->
<h1 id="sTitle">MECO INFRASTRUCTURE PVT LTD FOR SALE<br/>
<span id="title">Business For Sale Of Manufacturing Businesses At Karnataka, Krishnarajapura, India</span>
</h1>
<!--title finish-->
<!--post start-->
<p class="post-on">Posted on: 20-Jan-2023</p>
<!--post finish-->
<div class="row">
 ...
 <!-- <ul class="carousel-indicators">
  ...
  <div class="carousel-inner mb-20">
    <div class="carousel-item active">
      <img id="img1" src="images/noimage.jpg" class="br-20" alt="Service banner 1" width="100%" height="auto">
        
    </div>
    <div class="carousel-item">
      <img id="img2" src="images/noimage.jpg" class="br-20" alt="Service banner 2" width="100%" height="auto">
        
    </div>
    <div class="carousel-item">
      <img id="img3" src="images/noimage.jpg" class="br-20" alt="Service banner 3" width="100%" height="auto">
...
<h2 class="contact-h2">Contact Seller</h2>
<form>
<div class="row">
...
<div class="input-group mb-3">
  ...
  <input type="text" class="form-control login-user" placeholder="parag.gogari@gmail.com" aria-label="Username" aria-describedby="basic-addon1">
</div>
...
<div class="form-group required-field-block">       
        <div class="col-md-12 input-group">
            <span class="input-group-addon"><img src="images/commnet.png" width="31" height="20"/></span>
            <textarea rows="4" size="50" value="" class="form-control interested" placeholder="Please send me more details, Interested in the business ,Thanks"></textarea>  
        </div>
    </div>
	<!-- What you liked about us finish -->
	 <!-- submit button start -->
 <button type="submit" class="btn login-submit-button">Submit</button>
...
<!--Business Description start-->
<p id="businessDescription" class="business-text"><span class="business-description">Business Description</span><br/>
MS PORTABLE CABIN MANUFACTURER - <br/>Office cabin , security cabin , toilet cabin , house cabin , shop cabin ,farm house cabin , modular house , mobile toilet
</p>
<!--Business Description finish-->
<!--Business Category start-->
<p id="businessCategory" class="business-text"><span class="business-description">Business Category</span><br/>
Manufacturing Businesses<br/>
Fabrication business
</p>
<!--Business Category finish-->
<!--Business Location start-->
<p class="business-text"><span class="business-description" id="businessLocation">Business Location</span><br/>
Krishnarajapura, Karnataka, India
</p>
<!--Business Location finish-->
<!--Business Features start-->
<p class="business-text" id="businessFeatures"><span class="business-description" >Business Features</span><br/>
Attractive Business
</p>
<!--Business Features finish-->
<!--Operational Information start-->
<p class="business-text"><span class="business-description">Operational Information</span><br/>
Year of Establishment : N/A<br/>
No of Employee : N/A<br/>
No of Years trading :<br/>
Trading Hours From : N/A<br/>
Trading Hours To: 9
</p>
<!--Operational Information finish-->
<!--Company Details start-->
<p class="business-text"><span class="business-description">Company Details</span><br/>
Type : N/A<Br/>
Status : In Active
</p>
<!--Company Details finish-->
<!--Profit & Pricing start-->
<p class="business-text" id="businessText">
<span class="business-description">Profit & Pricing</span><br/>
Business Turnover : 5000000-0 INR /Annum<br/>
Total Expenses : 750000-1000000 INR /Annum<Br/>
Gross profit : 5000000-0 INR<br/>
Net profit : 2500000-50000000 INR<Br/>
Included Plant & Fixture fittings<br/>
Included Estimated Stock
</p>
<!--Profit & Pricing finish-->
</div>
</div>
</div>
...
<div class="wishlist-seller"><img src="images/listing.png" width="27" title="Add to Favorite" alt="Add to Favorite" style="margin-right:5px;" height="19"/> Add to Favorite</div>
<!--Add to Favorite finish-->
<!--View Contact start-->
<div class="wishlist-seller"><img src="images/phone-icon.png" title="View Contact" alt="View Contact" width="27" style="margin-right:5px;" height="19"/> View Contact</div>
<!--View Contact finish-->
<!--social start-->
<div class="social-seller"><span><a href="#"><img src="images/facebook-icon.png" title="Facebook" alt="Facebook" width="25" height="25"/></a></span> <span><a href="#"><img src="images/linkedin-icon.png" title="Linkedin" alt="Linkedin" width="25" height="25"/></a></span> <span><a href="#"><img src="images/twitter.png" width="25" title="Twitter" alt="Twitter" height="25"/></a></span></div>
<!--social icon finish-->
<!--listing start-->
<div class="listing-id">Listing ID<br/><span id="businessListingId">L-34603</span></div>
<div class="listing-id">Listing Type<br/><span id="listingFor">SALE</span></div>
<div class="listing-id">Listing Category<br/><span id="listingType">Business</span></div>
<div class="listing-id">Total Views<br/><span>49</span></div>
<div class="listing-id">Pricing<br/><span>INR 15,000,000</span></div>
<!--finish finish-->
</div>
</div>
</div>
...
<!--  <script src="js/jquery.slim.min.js"></script> -->
  ...
  var id = sessionStorage.getItem("listingId");
	
	 var getUrl = window.location;
	 
	 var url = getUrl .protocol + "//" + getUrl.host + "/getBusineeListingbyListingId" ;
		...
		$.ajax({
		    ...
		    dataType: 'json',
		      success: function(data) {
		    	  var sTitle = data[0].suggestedTitle;
		    	  sTitle+="  <br/>";
		    	  sTitle+="  <span id=\"title\"></span>";
		        $("#sTitle").html(sTitle);
		        $("#title").html(data[0].title);
		        #("#businessListingId").html(data[0].businessListingId);
		        $("#listingFor").html(data[0].listingFor);
		        $("#listingType").html(data[0].listingType);
		        var description = "<span class=business-description>Business Description</span><br/>";
		        description+=data[0].description;
		        console.log ("DESC :"+description);
		        $("#businessDescription").html(description);
		        console.log("Feature :"+data[0].businessListingFeatureInfos[0].businessFeatureDTO.name);
		        var feature = "<span class=\"business-description\" >Business Features</span><br/>";
		        feature += data[0].businessListingFeatureInfos[0].businessFeatureDTO.name;
		        feature+= "</p>";
		        $("#businessFeatures").html(feature);
		        				       
		        var category = "<span class=business-description>Business Category</span><br/>";
		        category+=data[0].categoryList;
		        $("#businessCategory").html(category);
		        
		        var businessText = "<span class=\"business-description\">Profit & Pricing</span><br/>";
		        businessText+= "Business Turnover : "+data[0].businessTurnOver+"<br/>";
		        businessText+="Total Expenses : "+data[0].businessTotalExpenses+"<Br/>";
		        businessText+="Gross profit : "+data[0].grossProfit+"<br/>";
		        businessText+="Net profit : "+data[0].netProfit+"<Br/>";
		        businessText+"Included Plant & Fixture fittings<br/>Included Estimated Stock";
		        $("#businessText").html(businessText);
		        if(data[0].filePath1 != null || data[0].filePath1 != undefined){
		        	 $("#img1").attr("src",data[0].filePath1);
		        	    $("#img3").attr("src",data[0].filePath1);
		        }
		        else {
		        	 $("#img1").attr("src","noimage.jpg");
		        }
		         
		        if(data[0].filePath2 != null || data[0].filePath2 != undefined){
		        	 $("#img2").attr("src",data[0].filePath2);
		        }
		        else {
		        	 $("#img1").attr("src","noimage.jpg");
		        }
